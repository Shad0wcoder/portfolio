    ...
    return (
        <section className="w-full py-20">
            <h1 className="flex item-center justify-center lg:text-5xl md:text-3xl text-xl font-bold text-white">
                My<span className="text-purple-300 ml-2">approach
                </span>
            </h1>
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card title="Planning & Strategy" icon={<AceternityIcon order="Phase 1" />}
                description="In this phase, Understanding the project requirements and setting clear goals."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                description="Bringing Designs to Life - This phase involved turning ideas into a functional, interactive website.">
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card title="Development & Optimization" icon={<AceternityIcon order="Phase 3"/>}
                description="Going Live & Improving - After building, I prepared the portfolio for public viewing">
                    <CanvasRevealEffect
                        animationSpeed={3}
